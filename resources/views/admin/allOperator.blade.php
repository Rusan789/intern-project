    ...
    <div class="route pt-5 pb-5">
        ...
        <div class="container route-container">
            <div class="route-hb d-flex justify-content-between pt-4">
                ...
                <button type="button" class="btn btn-success"><a href="{{ route("addOperator") }}" class="admin-a-btn">Create Operator &rarr;</a></button>
            </div>  
            ...
            <table class="table table-striped text-center" style="width: 100%; margin: auto;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-primary"><a href="{{ route("editOperator") }}" class="admin-a-action">Edit<i class="fas fa-edit admin-fa"></i></a></button>
